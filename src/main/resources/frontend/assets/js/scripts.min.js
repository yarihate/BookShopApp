                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                getData('/api/books/by-author/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/books/rateBookReview/' + $('[data-bookslug]').data('bookslug'), data, function (result) {
                            if (result.result) {
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/changeBookStatus/rating/' + $('[data-bookid]').data('bookid'), {
            ...
            return {
                init: function () {
                    $('form.Topup').on('submit', function (e) {
                        var $this = $(this);
                        e.preventDefault();
                        Login().postData('/books/topupaccount', {
